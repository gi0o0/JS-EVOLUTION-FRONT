...
export class PortfolioSearchComponent implements OnInit {
  ...
  displayedColumns = ['baseDatos', 'nomTer', 'numeroCredito', 'vSolicita', 'valorCuot', 'nroCuotas', 'cuoCau', 'cuoPag', 'cuoMora', 'saldoK', 'indicador', 'nomClaaso', 'nomClaasoCod', 'marcacionn', 'estPersonaDeu', 'estPersonaCoDeu'];
