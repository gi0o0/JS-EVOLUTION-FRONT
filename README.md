...
* Ì†ΩÌ≤™  [CoreUI Pro Bootstrap Admin Template](https://coreui.io/pro/)
* Ì†ΩÌ≤™  [CoreUI Pro Bootstrap Admin Template (Ajax)](https://coreui.io/pro/)
* Ì†ΩÌ≤™  [CoreUI Pro Angular Admin Template](https://coreui.io/pro/angular)
* Ì†ΩÌ≤™  [CoreUI Pro React Admin Template](https://coreui.io/pro/react)
* Ì†ΩÌ≤™  [CoreUI Pro Vue Admin Template](https://coreui.io/pro/vue)
...
copyright 2017-2021 creativeLabs ≈Åukasz Holeczek. Code released under [the MIT license](https://github.com/coreui/coreui-free-angular-admin-template/blob/master/LICENSE).
There is only one limitation you can't re-distribute the CoreUI as stock. You can‚Äôt do this if you modify the CoreUI. In past we faced some problems with persons who tried to sell CoreUI based templates.
